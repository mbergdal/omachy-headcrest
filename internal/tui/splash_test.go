...
func TestRenderSplash(t *testing.T) {
	...
	tools := []string{"AeroSpace", "Ghostty", "Neovim", "Zed", "Zen Browser", "Raycast", "1Password", "Superhuman", "Claude", "ChatGPT", "Tmux", "Yazi", "Docker", "Colima", "eza", "bat", "mise", "Node", "Bun", "Elixir"}
